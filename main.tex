...
\input{chapter/030-evakuierung.tex}
...
\input{chapter/050 gedenken.tex}

%%%%
%%\chapter{Zusammenfassung}
\input{chapter/060-zusammenfassung.tex}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{Testimonien}
\input{chapter/070-testimonies.tex}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{chapter/080-opferlisten.tex}
...
\input{chapter/090-verzeichnisse.tex}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{chapter/100-about.tex}
